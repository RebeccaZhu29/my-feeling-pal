  ...
  return (
    <div className="min-h-screen bg-emerald-800">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-12">
        <h1 className="text-cream text-4xl font-serif text-center mb-16">
          ...
          {feelings.map((feeling) => (
            selectedFeeling === null || selectedFeeling === feeling.type ? (
              ...
              >
                ...
                <div className="bg-cream px-6 py-2 rounded-full drop-shadow-lg">
                  <span className={`${feeling.color} font-bold`}>
                    {feeling.label}
                  </span>
                </div>
              </div>
        ...
        {selectedFeeling && (
          <div className="mt-8 text-center">
            <button
              ...
              className="px-6 py-2 bg-cream text-purple-700 rounded-full 
                hover:bg-purple-700 hover:text-cream transition-colors duration-300"
            >
